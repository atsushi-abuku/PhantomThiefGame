...
//     version 1.14.0
//     from Assets/Scripts/Thief/ThiefInput.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Scripts/Thief/ThiefInput.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @ThiefInput: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    ""maps"": [
        {
            ""name"": ""Move"",
            ""id"": ""e11820a4-7d7f-4825-aa9c-f833fd93ab5b"",
            ""actions"": [
                {
                    ""name"": ""MoveRight"",
                    ""type"": ""Button"",
                    ""id"": ""b72c014a-ed30-4e72-b3d3-e02660e4d6b3"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                ...
                },
                {
                    ""name"": ""MoveLeft"",
                    ""type"": ""Button"",
                    ""id"": ""dedfbcea-c066-40d9-a934-1e87c834e0bc"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""Jump"",
                    ""type"": ""Button"",
                    ""id"": ""0fa1be22-97e5-4ca7-900b-a0f783ddea70"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""0be3fd55-3275-4b23-bcea-fa3d1b476aa3"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""13e7e179-30d4-4e45-87f4-43d03bae6f89"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""58a2107c-b158-4a3b-93d2-545a28e41e35"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
        ...
        {
            ""name"": ""Visual"",
            ""id"": ""3c27934c-8386-4914-87c6-040cd70d1187"",
            ""actions"": [
                {
                    ""name"": ""Change"",
                    ""type"": ""Button"",
                    ""id"": ""3af31486-2dbb-4f56-bfde-281c26f049ec"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""363ac0d8-6da9-4a95-a41e-dbeda20eaf1c"",
                    ""path"": ""<Keyboard>/q"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    public struct MoveActions
    {
        ...
        /// </summary>
        public MoveActions(@ThiefInput wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    // Visual
    private readonly InputActionMap m_Visual;
    private List<IVisualActions> m_VisualActionsCallbackInterfaces = new List<IVisualActions>();
    private readonly InputAction m_Visual_Change;
    /// <summary>
    /// Provides access to input actions defined in input action map "Visual".
    /// </summary>
    public struct VisualActions
    {
        private @ThiefInput m_Wrapper;
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public VisualActions(@ThiefInput wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Visual/Change".
        /// </summary>
        public InputAction @Change => m_Wrapper.m_Visual_Change;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        public InputActionMap Get() { return m_Wrapper.m_Visual; }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
        public void Enable() { Get().Enable(); }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
        public void Disable() { Get().Disable(); }
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="VisualActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        public static implicit operator InputActionMap(VisualActions set) { return set.Get(); }
        /// <summary>
        /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
        /// </summary>
        /// <param name="instance">Callback instance.</param>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="VisualActions" />
        public void AddCallbacks(IVisualActions instance)
        {
            if (instance == null || m_Wrapper.m_VisualActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_VisualActionsCallbackInterfaces.Add(instance);
        ...
        /// </remarks>
        /// <seealso cref="VisualActions" />
        private void UnregisterCallbacks(IVisualActions instance)
        {
            @Change.started -= instance.OnChange;
            @Change.performed -= instance.OnChange;
            @Change.canceled -= instance.OnChange;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="VisualActions.UnregisterCallbacks(IVisualActions)" />.
        /// </summary>
        /// <seealso cref="VisualActions.UnregisterCallbacks(IVisualActions)" />
        public void RemoveCallbacks(IVisualActions instance)
        {
            if (m_Wrapper.m_VisualActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="VisualActions.AddCallbacks(IVisualActions)" />
        /// <seealso cref="VisualActions.RemoveCallbacks(IVisualActions)" />
        /// <seealso cref="VisualActions.UnregisterCallbacks(IVisualActions)" />
        public void SetCallbacks(IVisualActions instance)
        {
            foreach (var item in m_Wrapper.m_VisualActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_VisualActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    ...
    /// <seealso cref="VisualActions.AddCallbacks(IVisualActions)" />
    /// <seealso cref="VisualActions.RemoveCallbacks(IVisualActions)" />
    public interface IVisualActions
    {
        /// <summary>
